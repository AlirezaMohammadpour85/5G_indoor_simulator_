...
from histo_blers_per_gnodb import histo_blers_per_gnodb
...
for ue_dir in ue_dir_lst:
    ...
    # Now extract path tiles from each gNodeB blers
    sq_blers_dict = dict()
    index = 0
    ...
    # scenario 1
    gnodb_plot(gnodb_postion_lst_paper, tile_postion_list, ue=[50, 30], machine_tile=5, machine_3d=True,
               scenario_16=True)
    # scenario 4 select machine _tile < 615 blocking first gnodbe , machine_tile>615 block both gNodeBs
    # This part of code is added for new figures need to fixed for generating results automatically.
    gnodb_plot(gnodb_postion_lst_paper, tile_postion_list, ue=ue_coor, machine_tile=616, machine_3d=True)
    gnodb_plot(gnodb_postion_lst_paper, tile_postion_list, ue=ue_coor, machine_tile=620, machine_3d=True)
    # ===============================================================================================================
